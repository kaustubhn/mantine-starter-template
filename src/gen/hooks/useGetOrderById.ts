...
import type { GetOrderByIdQueryResponse, GetOrderByIdPathParams, GetOrderById400, GetOrderById404 } from "../types/GetOrderById";
...
export function getOrderByIdQueryOptions<TData = GetOrderById["response"], TQueryData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options: GetOrderById["client"]["parameters"] = {}): WithRequired<UseBaseQueryOptions<GetOrderById["response"], GetOrderById["error"], TData, TQueryData>, "queryKey"> {
 ...
 */
export function useGetOrderById<TData = GetOrderById["response"], TQueryData = GetOrderById["response"], TQueryKey extends QueryKey = GetOrderByIdQueryKey>(orderId: GetOrderByIdPathParams["orderId"], options: {
