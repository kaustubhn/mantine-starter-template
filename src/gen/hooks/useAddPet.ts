...
import type { AddPetMutationRequest, AddPetMutationResponse, AddPet400, AddPet422 } from "../types/AddPet";
import type { UseMutationOptions, UseMutationResult } from "@tanstack/react-query";

 type AddPetClient = typeof client<AddPetMutationResponse, AddPet400 | AddPet422, AddPetMutationRequest>;
type AddPet = {
    data: AddPetMutationResponse;
    error: AddPet400 | AddPet422;
