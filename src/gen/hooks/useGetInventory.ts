...
import type { GetInventoryQueryResponse } from "../types/GetInventory";
...
export function getInventoryQueryOptions<TData = GetInventory["response"], TQueryData = GetInventory["response"]>(options: GetInventory["client"]["parameters"] = {}): WithRequired<UseBaseQueryOptions<GetInventory["response"], GetInventory["error"], TData, TQueryData>, "queryKey"> {
