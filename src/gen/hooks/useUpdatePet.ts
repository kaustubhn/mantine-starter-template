...
import type { UpdatePetMutationRequest, UpdatePetMutationResponse, UpdatePet400, UpdatePet404, UpdatePet422 } from "../types/UpdatePet";
import type { UseMutationOptions, UseMutationResult } from "@tanstack/react-query";

 type UpdatePetClient = typeof client<UpdatePetMutationResponse, UpdatePet400 | UpdatePet404 | UpdatePet422, UpdatePetMutationRequest>;
type UpdatePet = {
    data: UpdatePetMutationResponse;
    error: UpdatePet400 | UpdatePet404 | UpdatePet422;
